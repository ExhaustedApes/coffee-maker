...
public class StoreHall extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        past_client = firstIntent.getIntExtra("client_index", -1);
        ...
        Log.d("index", "when moved form kitchen past weather, client, order: "+past_weather+" "+past_client+" "+past_order);
        ...
        if(getIntent!=1) {
            ...
            Log.d("index", "when new client come to store, weather, client, order: "+weather+" "+clientNum+" "+order);
        }
        ...
        moveKitchen.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                secondIntent.putExtra("client_index", clientNum);
                secondIntent.putExtra("weather_index", weather);
                secondIntent.putExtra("time_index", time);
                Log.d("index", "when move kitchen weather, client, order: "+weather+" "+clientNum+" "+order);
    ...
    private void showClient(Integer order, Integer clientNum, Integer time, Integer getIntent, ImageView clientImg, TextView clientOrder, Button moveKitchen) {
        new Handler().postDelayed(new Runnable() {
            ...
            public void run() {
                ...
                if (clientNum==1) clientImg.setImageResource(R.drawable.client);
                ...
                else if (clientNum==8) clientImg.setImageResource(R.drawable.client8);
                else if (clientNum==9) clientImg.setImageResource(R.drawable.client9);
